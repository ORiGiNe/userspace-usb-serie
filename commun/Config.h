 ...
 *	Défini la taille d'une commande en octet FIXME berk, pas de lien avec l'objet en lui même, et 2 octets, vraiment nécessaires ?
*/
 ...
 *	On envoi une trame ayant l'ODID 0xFF pour débloquer une potentielle erreur (FIXME:lesquelles ?)
 */
